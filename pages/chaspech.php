...
$req = $DB->query("SELECT * FROM f_categories WHERE id = 4");
$req = $req->fetchAll();
$req2 = $DB->query("SELECT sujet, contenu, date_creation, id_user, id_topic FROM f_topics
    WHERE id_cat = 4 ORDER BY date_creation DESC");
$req2 = $req2->fetchAll();
foreach($req as $r){};
...
<body id="chasimage">
    ...
    <div class="container">
        <a id="ahref" href="accueil.php">Accueil</a> > Catégorie : Chasse & Peche
            <div class="row">   
